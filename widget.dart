...
I.	Find the your desired name class and the build() method within it. 
II.	As before, call up the Refactor menu on the Text widget. However, this time you aren't going to extract the widget.
III.	Instead, select Wrap with Padding. This creates a new parent widget around the Text widget called Padding. After saving, you'll see that the widget you added padding already has more breathing room.
...
2.	How can you display images in Flutter?
To display images in Flutter, you can use the Image widget. Here's an example: */
Image.network('https://example.com/image.jpg')

/*
1.	What is the purpose of the Expanded widget in Flutter?
...
2.	How can you navigate between screens in Flutter?
...
3.	What is the purpose of the SingleChildScrollView widget in Flutter?
...
4.	How can you add icons to your Flutter app?
...
5.	Explain the concept of widget composition in Flutter.
...
6.	How can you create a custom widget in Flutter?
...
7.	What is the purpose of the MediaQuery widget in Flutter?
...
8.	How can you create a dropdown menu in Flutter?
To create a dropdown menu in Flutter, you can use the DropdownButton widget along with the DropdownMenuItem widget.

9.	Explain how to handle user input using GestureDetector in Flutter.
